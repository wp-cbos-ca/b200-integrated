<?php
/**
Plugin Name: WP Bundle Base Limit Logins
Plugin URI: http://wp.cbos.ca/plugins/wp-bundle-base-limit-logins/
Description: Limit the rate of login attempts, including by way of cookies and for each IP address. Bundlified from Limit Login Attempts Reloaded.
Version: 2018.03.15
Author: wp.cbos.ca
Author URI: http://wp.cbos.ca/
License: GPLv2+

Original Plugin Name: Limit Login Attempts Reloaded
Original Description: Limit the rate of login attempts, including by way of cookies and for each IP address.
Original Author: wpchefgadget
Original Text Domain: limit-login-attempts-reloaded
Original Version: 2.6.3

Original Copyright 2008 - 2012 Johan Eenfeldt, 2016 - 2017 WPChef
