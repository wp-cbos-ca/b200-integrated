...
/**
Plugin Name: WP Bundle Security Site Password
Plugin URI: http://wp.cbos.ca/plugins/wp-bundle-security-site-password/
...
Original Plugin Name: Password Protected
Original Plugin URI: https://wordpress.org/plugins/password-protected/
Original Description: A very simple way to quickly password protect your WordPress site with a single password. Please note: This plugin does not restrict access to uploaded files and images and does not work with some caching setups.
Original Version: 2.1
Original Author: Ben Huson
Original Text Domain: password-protected
Original Author URI: http://github.com/benhuson/password-protected/
