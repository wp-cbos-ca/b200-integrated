<?php
/*
Plugin Name: WP Bundle WordPress Importer
Plugin URI: http://wp.cbos.ca/plugins/wp-bundle-wordpress-importer/
Description: Bundleifies the WordPress Importer. Import posts, pages, comments, custom fields, categories, tags and more from a WordPress export file. May include some adjustments. Set IMPORT_DEBUG to "true" in config file to debug.
Author: wp.cbos.ca
