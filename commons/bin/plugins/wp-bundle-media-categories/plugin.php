<?php
/*
Plugin Name: WP Bundle Media Categories
Plugin URI: http://wp.cbos.ca/plugins/wp-bundle-media-categories/
...
/*
Original Plugin Name: Media Library Categories
Original Plugin URI: https://wordpress.org/plugins/wp-media-library-categories/
Original Description: Adds the ability to use categories in the media library.
Original Version: 1.6.1
Original Author: Jeffrey-WP
Original Text Domain: wp-media-library-categories
Original Domain Path: /languages
Original Author URI: https://codecanyon.net/user/jeffrey-wp/?ref=jeffrey-wp
*/
