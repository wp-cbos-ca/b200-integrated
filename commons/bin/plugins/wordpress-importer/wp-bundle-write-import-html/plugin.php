<?php
/**
Plugin Name: WP Bundle Write Import HTML
Plugin URI: http://wp.cbos.ca/plugins/wp-bundle-write-import-html/
Description: Start writing before your blog is built. Use simple HTML tags such as &lt;h1&gt; and &lt;p&gt; in your article using plain text. Then import using this plugin.
Version: 2018.03.19
Author: wp.cbos.ca
Author URI: wp.cbos.ca
License: GPLv2+

Original Plugin Name: HTML Import 2
Original Plugin URI: http://sillybean.net/code/wordpress/html-import/
Original Description: Imports well-formed static HTML files into WordPress posts or pages. Supports Dreamweaver templates and Word HTML cleanup. Visit the settings page to get started. See the <a href="http://sillybean.net/code/wordpress/html-import-2/user-guide/">User Guide</a> for details.
Original Version: 2.6
Original Author: Stephanie Leary
Original Author URI: http://sillybean.net/
...
function html_import_activation_check() {
	// we are running > PHP 5.0 by default. Always return true;
	return true;
}
...
function html_import_css() {
    wp_register_style( 'html-import-css', plugins_url( 'css/style.css', __FILE__ ) );
