 ...
 * Original Name: Maintenance Mode
 * Original URI: https://plugins.itsluk.as/maintenance-mode/
 * Original Description: Very simple Maintenance Mode & Coming soon page using default Wordpress markup with no ads or paid upgrades.
 * Original Version: 2.4.3
 * Original Auth.: Lukas Juhas
 * Original Auth. URI: https://plugins.itsluk.as/
 * Original Domain: lj-maintenance-mode
 * License: GPLv2+
 * Original Path: /languages/
 *
 * Copyright 2014-2017  Lukas Juhas

 * @ original package lj-maintenance-mode
 * @ original author Lukas Juhas
 * @ original version 2.4.3
 *
 */
...
function ljmm_get_defaults($type)
{
	switch ($type) {
		...
		case 'warning_comet_cache':
			...
			break;
		case 'ljmm_enabled':
//incognito mode, different browser or simply log out. Logged in users are not affected by the Maintenance Mode.', LJMM_PLUGIN_DOMAIN);
			break;
