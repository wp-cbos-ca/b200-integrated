...
Plugin Name: WP Bundle Write Charts
Plugin URI: http://wp.cbos.ca/plugins/wp-bundle-write-charts
Description: Create amazing HTML5 charts easily in WordPress. Includes 6 customizable chart types (line, bar, pie, radar, polar area and doughnut types).  Incorporates the fantastic chart.js script : http://www.chartjs.org/.
Version: 2018.03.19
Author:  wp.cbos.ca
Author URI: http://wp.cbos.ca

Original Plugin Name: WordPress Charts
Original Plugin URI: http://wordpress.org/plugins/wp-charts/
Original Description: Create amazing HTML5 charts easily in WordPress. A flexible and lightweight WordPress chart plugin including 6 customizable chart types (line, bar, pie, radar, polar area and doughnut types) as well as a fallback to provide support for older IE.  Incorporates the fantastic chart.js script : http://www.chartjs.org/.
Original Version: 0.7.0
Original Author:  Paul van Zyl
Original Author URI: http://profiles.wordpress.org/pushplaybang/
*/
