...
/*
Plugin Name: WP Bundle Write Reference
Plugin URI: http://wp.cbos.ca/plugins/wp-bundle-write-reference/
Description: WP Bundle Write Reference (papercite) enables to add BibTeX entries formatted as HTML in wordpress pages and posts. The input data is the bibtex text file and the output is HTML.
Version: 2018.06.01
Author: wp.cbos.ca
...
/*
Original Plugin Name: papercite
Original Plugin URI: http://www.bpiwowar.net/papercite
Original Description: papercite enables to add BibTeX entries formatted as HTML in wordpress pages and posts. The input data is the bibtex text file and the output is HTML. 
Original Version: 0.5.18
Original Author: Benjamin Piwowarski
Original Author URI: http://www.bpiwowar.net
*/
